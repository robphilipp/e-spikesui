 ...
 * @param fragments The additional fragments
 * @return A regular expression object that is constructed from the specified fragments
 */
 ...
 * @param regex The string representation of a regular expression or a regular expression
