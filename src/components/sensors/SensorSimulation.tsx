...
interface Props {
    ...
    // sensorObservable: Observable<SensorOutput>;
    // observable: Observable<ChartData>;
    // expressionState: ExpressionState;
    // onUpdateExpressionState: (state: ExpressionState) => void;
    codeSnippet: string;
...
export default function SensorSimulation(props: Props): JSX.Element {
    ...
    // const [observable, setObservable] = useState<Observable<ChartData>>();
