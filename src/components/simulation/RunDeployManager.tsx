    ...
    return (
        <Grid
            ...
            gridTemplateAreas={gridTemplateAreasBuilder()
                .addArea('networkManagementButtons', gridArea(1, 1))
                .addArea('networkControls', gridArea(2, 1))
                .addArea('networkCharts', gridArea(3, 1))
                .build()
            }
            rowGap={0}
            columnGap={0}
            ...
            <GridCell gridAreaName='networkCharts'>
                <Grid
                    ...
                    gridTemplateAreas={gridTemplateAreasBuilder()
                        ...
                        .addArea('networkWeightsChart', gridArea(2, 2))
                        .build()
                    }
                >
