...
//  */
// export interface UseSceneValues {
...
// // export const initialSceneValues: UseSceneValues = {
...
// //  * @type {React.Context<UseSceneValues>} The react context holding the three scenes
// //  */
// // const ScenesContext = createContext<UseSceneValues>(initialSceneValues);
// //
// // interface Props {
// //     scenesSupplier?: () => Array<SceneInfo>
// //     destroy?: (scenes: Array<SceneInfo>) => void
// //     children: JSX.Element | JSX.Element[]
// // }
//
// // /**
// //  *
// //  * @param props Properties with the option scene supplier, destroy callback, and the
// //  * children elements
// //  * @constructor
// //  */
// // export function ScenesProvider(props: Props): JSX.Element {
// //     const {
// //         scenesSupplier = () => [],
// //         destroy = noop,
// //         children
// //     } = props;
// //
// //     const [scenes, setScenes] = useState<Array<SceneInfo>>([])
// //
...
// //
// //     return (
// //         <ScenesContext.Provider value={{sceneFor, addToScene, visibility, isVisible, scenes, clearScenes}}>
// //             {children}
// //         </ScenesContext.Provider>
// //     )
// // }
//
// // export function useScenes(): UseSceneValues {
// //     const context = useContext<UseSceneValues>(ScenesContext);
// //     const {sceneFor, addToScene} = context
// //     if (sceneFor === undefined || addToScene === undefined) {
// //         throw new Error("useScenes can only be used when the parent is a <ScenesProvider/>")
// //     }
// //     return context
// // }
//
...
//  * @return {UseSceneValues} The scene context holding the scenes and an accessor function.
//  */
// // export function useScenes(
// //     scenesSupplier: () => Array<SceneInfo> = () => [],
// //     // scenesSupplier: () => Vector<SceneInfo> = () => Vector.empty(),
// //     destroy?: (scenes: UseSceneValues) => void
// // ): UseSceneValues {
// //
// //     const context = useContext<UseSceneValues>(SceneContext);
// //
// //     // /**
// //     //  * Returns the scene for the specified name
// //     //  * @param {string} sceneId The ID of the scene (generally a descriptive name)
